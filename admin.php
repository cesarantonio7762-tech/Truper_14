...
if (isset($_POST['guardar'])) {
    ...
    $conexion->query("
        INSERT INTO Herramientas(nombre, precio, stock)
...
if (isset($_GET['eliminar'])) {
    ...
    $conexion->query("
        ...
        WHERE id=$id
    ") or die("Error SQL: " . $conexion->error);
...
<!-- TABLA -->
<table id="tabla" class="table table-striped table-hover shadow">
...
<a class='btn btn-primary btn-sm' href='?editar={$row['id']}#tabla'>Editar</a>
    ...
    <div class="modal-content">
      ...
      <form method="POST">
        ...
        <div class="modal-body">
          ...
          <input class="form-control mb-2" type="number" name="stock" placeholder="Unidades disponibles" required>
